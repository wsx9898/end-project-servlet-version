...
<body class="product-page">
												...
												<div class="add-to-box">
													<div class="add-to-cart">
														...
														<button onClick="productAddToCartForm.submit(this)"
															class="button btn-cart" title="Add to Cart" type="button">加入購物車
														</button>
														<button onClick="productBuyDirectForm.submit(this)"
	...
	<script>
        ...
        $(function () {
            ...
            //Ted的方法
                var settings = {
                    "url": "http://bosian.ddns.net:8080/IIIFinalServlet_war_exploded/ProductServlet?pdaction=Select1&editProductId=87",
                    "method": "POST",
                    "timeout": 0,
                };
