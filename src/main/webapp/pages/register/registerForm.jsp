										...
										<fieldset>
											...
											<li>
													<div class="input-box member-account">
														<label for="memberAccouunt">ID號<span
															class="required">*</span>
														</label><br> <input type="text" id="memberId"
															name="memberId" value="${param.memberId}"
															title="ID" class="input-text "><br>
												...
												<li>
													<div class="input-box member-password">
														<label for="billing:password">密 碼<span
															class="required">*</span>
												...
												<li>
													...
													<div class="input-box">
														<label for="memberGender">性 別</label><br> 
														<%-- <input
															type="text" id="memberGender" name="memberGender"
															value="${param.memberGender}" title="Gender"
															class="input-text"> --%>
															
															<input type="radio" id="html" name="gender" value="male" checked>
															  <label for="html">男生</label><br>
															  <input type="radio" id="css" name="gender" value="female">
															  <label for="css">女生</label><br>
