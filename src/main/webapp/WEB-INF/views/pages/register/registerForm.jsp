...
<%--														<label for="memberIdTemp">ID號<span--%>
<%--															class="required">*</span>--%>
<%--														</label><br> <input type="text" id="memberIdTemp"--%>
<%--															name="memberIdTemp" value="${param.memberIdTemp}"--%>
<%--															title="ID" class="input-text "><br>--%>
<%--															<span class="error">${errors.memberIdTemp}</span>--%>
<%--													</div>--%>
<%--												</li>--%>
												<li>
													<div class="input-box member-account">
